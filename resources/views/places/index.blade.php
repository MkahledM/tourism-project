...
<!-- {{-- @foreach ($data as $item)
    <div class="card mb-3" style="max-width: 540px;">
        ...
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img/{{$item->name_img}}" class="img-fluid rounded-start" >
            <img src="img/{{$item->name_img2}}" class="img-fluid rounded-start" >
          </div>
          <div class="col-md-8">
            <div class="card-body">
...
@endforeach --}} -->
    <!-- About Start -->
        ...
        <h1 class="m-0 text-white display-4 text-center"><span class="text-primary">P</span><span class="text-primary">la</span><span class="text-primary">c</span><span class="text-primary">es</span></h1>
